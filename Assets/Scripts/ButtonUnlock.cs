...
public class SequenceButtonUnlocker : MonoBehaviour
{
    public static SequenceButtonUnlocker Instance;

    [Header("Button Sequence Settings")]
    public List<string> correctSequence = new List<string> { "red", "blue", "green", "red" };
    ...
    public void RegisterPress(string buttonName)
    {
